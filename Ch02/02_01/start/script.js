...
//when you call a method/function you use (), if you wish to pass a value, goes inside ()
console.log(typeof myNumber);
// use console to see what code is doing. accesses console tool then acceses the log function of te console tool
